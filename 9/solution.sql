...
-- 22
-- невозможно сделать так как в постгрес нет триггера срабатывающего в определенное время
-- если сделать без времени то если никто не купит билет то и таблица обновлена не будет
-- так как не сработает триггер
